...
export const CreateEvents: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      className="max-w-4xl mx-auto p-6 mt-10 bg-white rounded-2xl shadow-xl"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-orange-300 focus:ring-2 focus:ring-orange-400 focus:outline-none rounded-xl shadow-sm"
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border border-orange-300 focus:ring-2 focus:ring-orange-400 focus:outline-none rounded-xl shadow-sm"
              rows={4}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2 border border-orange-400 bg-white rounded-xl text-sm shadow-sm hover:border-orange-500 focus:ring-2 focus:ring-orange-400 focus:outline-none"
            >
